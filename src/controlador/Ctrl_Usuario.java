...
public class Ctrl_Usuario {
    ...
    public boolean logginUser(Modelo_Usuario user){
        ...
        String sql="select usuario, contraseña from usuario where usuario = '"+user.getUsuario()+"' and contraseña= '" + user.getPassword() + "';";
        Statement st;
    ...
    public boolean eliminarUsuario(int idUsuario) {
        ...
        Connection cx = conexion.ConectionDB.conectar();
        try {
            PreparedStatement st = cx.prepareStatement("delete from usuario where id_usuario='" + idUsuario + "'");
            st.executeUpdate();
